...
import { useTopRatedTVSeries } from '../hooks/useMovies';
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 text-xl animate-fade-in" style={{animationDelay: '0.1s'}}>
            Las series con las mejores puntuaciones de la crítica
          </p>
        ...
        <div className="space-y-12">
          <div className="animate-slide-in-right" style={{animationDelay: '0.3s'}}>
            <TVSeriesRow
              title="🎯 Top Series de Todos los Tiempos"
